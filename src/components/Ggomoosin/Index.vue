...
<div id="hdg-noi-dung-ggomoosin" class="h-full"></div>
    </el-splitter-panel>
    </el-splitter>
...
<div id="hdg-noi-dung-ggomoosin" class="h-full"></div>
  ...
  <!-- ══════════════════════════════════════════════════════════════════
       ...
       ⚠️ `defer` LÀ BẮT BUỘC. Không có nó, Teleport đi tìm `#hdg-noi-dung-ggomoosin`
       ...
       ══════════════════════════════════════════════════════════════════ -->
  <Teleport defer to="#hdg-noi-dung-ggomoosin">
