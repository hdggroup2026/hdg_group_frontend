<template>
  <div class="reminder-container h-full flex flex-col">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden flex flex-col flex-1 min-h-0">
      <el-table v-loading="loading" :data="paginatedReminders" style="width: 100%" class="flex-1" height="100%">
        <!-- STT Column -->
        ...
        <!-- Mã tài liệu -->
        <el-table-column prop="document_id" label="Mã tài liệu" width="120" fixed show-overflow-tooltip>
        ...
        <!-- Tên tài liệu -->
        <el-table-column label="Tên tài liệu liên kết" min-width="180" show-overflow-tooltip>
          <template #default="{ row }">
        ...
        <!-- Nội dung nhắc nhở -->
        <el-table-column prop="reminder_content" label="Nội dung thông báo" min-width="200" show-overflow-tooltip />

        <!-- Mốc thời gian -->
        <el-table-column label="Mốc thời gian nhắc" width="160" align="center">
          <template #default="{ row }">
        ...
        <!-- Giờ nhắc -->
        <el-table-column prop="reminder_time" label="Giờ nhắc" width="100" align="center">
          <template #default="{ row }">
        ...
        <!-- Tần suất -->
        <el-table-column prop="recurring_interval" label="Tần suất" width="120" align="center">
          <template #default="{ row }">
        ...
        <!-- Telegram Group -->
        <el-table-column prop="telegram_group_id" label="Nhóm Telegram" width="130" show-overflow-tooltip>
          <template #default="{ row }">
        ...
        <!-- Đã thông báo -->
        <el-table-column prop="is_notified" label="Đã gửi?" width="100" align="center">
          <template #default="{ row }">
