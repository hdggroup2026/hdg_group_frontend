<template>
  <div class="phone-container h-full flex flex-col">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden flex flex-col flex-1 min-h-0">
      <el-table v-loading="loading" :data="paginatedSmartphones" style="width: 100%" class="flex-1" height="100%">
        <!-- STT Column -->
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="Phiên bản HĐH" prop="os_version">
                  <el-input v-model="form.os_version" placeholder="VD: iOS 17.5 hoặc Android 14" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
