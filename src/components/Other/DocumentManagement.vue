        ...
        <div class="document-tab-container h-full flex flex-col">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden flex flex-col flex-1 min-h-0">
            <el-table v-loading="loading" :data="paginatedDocuments" style="width: 100%" class="flex-1" height="100%">
              ...
              <!-- Số hiệu tài liệu -->
              <el-table-column prop="document_code" label="Số hiệu" width="130" fixed show-overflow-tooltip>
                <template #default="{ row }">
              ...
              <!-- Tiêu đề / Tên -->
              <el-table-column prop="title" label="Tên tài liệu / Tiêu đề" min-width="180" fixed show-overflow-tooltip>
                <template #default="{ row }">
              ...
              <!-- Danh mục -->
              <el-table-column prop="category" label="Danh mục" width="130" align="center" show-overflow-tooltip>
                <template #default="{ row }">
              ...
              <!-- Chủ sở hữu -->
              <el-table-column prop="owner_name" label="Người sở hữu" width="140" show-overflow-tooltip>
                <template #default="{ row }">
              ...
              <!-- Ngày cấp -->
              <el-table-column prop="issue_date" label="Ngày cấp" width="120" align="center">
                <template #default="{ row }">
              ...
              <!-- Ngày hết hạn -->
              <el-table-column prop="expiry_date" label="Hạn bảo hành / Hết hạn" width="130" align="center">
                <template #default="{ row }">
              ...
              <!-- Mô tả -->
              <el-table-column prop="description" label="Mô tả chi tiết" min-width="180" show-overflow-tooltip />
