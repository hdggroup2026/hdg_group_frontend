  ...
  <div class="credit-container h-full flex flex-col">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden flex flex-col flex-1 min-h-0">
      <el-table v-loading="loading" :data="paginatedData" style="width: 100%" class="flex-1" height="100%" @sort-change="handleSortChange">
        ...
        <el-table-column prop="remaining_principal" label="Gốc còn lại" width="180" align="right">
          <template #default="{ row }">
        ...
        <el-table-column prop="interest_debt" label="Nợ lãi" width="140" align="right">
          <template #default="{ row }">
        ...
        <el-table-column prop="start_date" label="Ngày bắt đầu" width="130" align="center">
          <template #default="{ row }">
            <span>{{ formatDate(row.start_date) }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="due_date" label="Ngày đáo hạn" width="130" align="center">
          <template #default="{ row }">
            <span>{{ formatDate(row.due_date) }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="send_message_arise" label="SMS tự động" width="120" align="center">
          <template #default="{ row }">
        ...
        <el-table-column prop="credit_status" label="Trạng thái" width="140" align="center" fixed="right">
          <template #default="{ row }">
