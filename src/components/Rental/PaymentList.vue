  ...
  <div class="rental-container h-full flex flex-col">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden flex flex-col flex-1 min-h-0">
      <el-table v-loading="loading" :data="paginatedData" style="width: 100%" class="flex-1" height="100%" @sort-change="handleSortChange">
        ...
        <el-table-column prop="payment_time" label="Giờ đóng" width="100" align="center">
          <template #default="{ row }">
          ...
          <div class="mb-4">
            ...
            <div v-if="selectedContractInfo" class="p-4 rounded-xl bg-gray-50 dark:bg-gray-900/60 border border-gray-100 dark:border-gray-800 text-xs mb-4 space-y-2 grid grid-cols-2 gap-4">
              ...
              <div class="flex justify-between pb-1">
                ...
                <span class="font-semibold text-gray-700 dark:text-gray-300">{{ formatCurrency(selectedContractInfo.monthly_rental) }}</span>
              </div>
              <div class="flex justify-between pb-1">
                <span class="text-gray-400">Công nợ hiện tại:</span>
                <span class="font-bold text-rose-600 dark:text-rose-400">{{ formatCurrency(selectedContractInfo.rental_debt) }}</span>
              </div>
            </div>
          </div>
