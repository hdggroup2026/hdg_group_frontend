    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
      ...
      >
        ...
        <div class="space-y-3 pt-3 border-t border-gray-50 dark:border-gray-700/40">
          ...
          <div class="flex justify-between items-center text-xs">
            <span class="text-gray-400 dark:text-gray-500 font-medium">Số lượng hiện tại</span>
            <span class="font-bold text-blue-600 dark:text-blue-400">{{ formatNumber(wh.currentQty) }} kg</span>
          </div>
